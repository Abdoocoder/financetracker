...
- سجل كامل للدفعات
- **تاريخ الديون المسددة** مع إحصائية إجمالي ما سددته 💪 *(جديد)*
- **احتفال + Confetti** عند سداد دين كامل 🎉 *(جديد)*
...
- **طلب إذن الإشعارات مرة واحدة فقط** *(جديد)*
...
- **Dark Mode افتراضي** لكل المستخدمين الجدد 🌙 *(جديد)*
...
- 🌍 إصلاح جميع النصوص المكتوبة مباشرة في صفحة الأهداف لاستخدام i18n
...
- 📱 APK للأندرويد
- ⚡ Lazy loading — تقليل bundle بنسبة 94%
...
✅ المرحلة الثانية — Smart Features
   ...
   ├── [x] تاريخ الديون المسددة + احتفال Confetti 🎉
   ├── [x] طلب إذن الإشعارات مرة واحدة فقط
   ├── [x] Landing Page محسّنة — Sticky CTA + Trust Signals
   └── [x] سياسة إشعارات ذكية
