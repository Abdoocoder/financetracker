...
- Name: transaction-management.spec.ts >> Transaction Management >> should show validation errors on invalid transaction
- Location: e2e\transaction-management.spec.ts:22:7
...
Call log:
  - waiting for getByRole('button', { name: 'إضافة معاملة' }).first()
