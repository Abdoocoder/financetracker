...
- Name: auth-flow.spec.ts >> Authentication Flow >> should allow switching between Login and Register
- Location: e2e\auth-flow.spec.ts:16:7
...
Call log:
  - waiting for getByText('سجل الآن')
