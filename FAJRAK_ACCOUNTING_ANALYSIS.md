...
### 4.4 آليات القياس والتوزيع

| المكون | الآلية |
|--------|--------|
| **الدخل** | يُقاس عند تاريخ المعاملة (transaction_date) |
| **المصروف** | يُقاس عند تاريخ المعاملة |
| **الاستثمارات** | القيمة السوقية = current_price × shares |
| **الديون** | القيمة الدفترية = remaining_amount |
| **التوزيع الشهري** | تصفية حسب transaction_date في الشهر |

### 4.5 آليات التسوية

1. **تسوية الحسابات**: تتم عبر مقارنة مجموع الأرصدة مع مجموع المعاملات
2. **تسوية الديون**: يتم تحديث remaining_amount عند كل دفعة
3. **تسوية العملات**: يتم استخدام exchange_rate لتوحيد العملة
