...
### v3.15.0+6 — 30 مارس 2026 *(الأحدث)*

| التغيير | الوصف |
|:-------|:------|
| 🔄 **إصلاح السبينر** | ضمان توقف علامة التحميل في جميع الشاشات (المعاملات، الاستثمارات، FIRE) حتى عند حدوث أخطاء |
| 📊 **ذكاء التصنيفات** | فصل تصنيفات الدخل عن المصاريف في القائمة السريعة وإضافة 7 تصنيفات جديدة |
| 🌄 **تجديد الهوية** | استبدال شعار الغروب القديم بشعار الشروق `🌄` وتعديل ألوان رقم الإصدار لسهولة القراءة |

### v3.14.0 — 25 مارس 2026
