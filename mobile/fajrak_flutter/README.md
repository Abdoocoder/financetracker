...
| 🔗 app_links | معالجة الـ Deep Links لإعادة تعيين كلمة المرور |
...
| **Modern UI** | تصميم عصري مع تدرجات لونية (Gradients) | ✅ |
| **Password Reset** | Deep Link أصلي `fajrak://` — حل PKCE على أندرويد | ✅ جديد |
...
| 🔗 **إعادة كلمة المرور** | Deep Link أصلي عبر `fajrak://reset-password` — يعترض رابط البريد الإلكتروني مباشرةً بدون متصفح |
